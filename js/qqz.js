...
document.writeln("<td 0="" style="\"background:transparent" url(\img\="" z_mid_1.gif)="" left="" top="" repeat-y;padding:0="" 6px;background-color:#fff;display:block;float:left;\"="">");
...
//document.writeln("<\/div>");
document.write("<a class='qqa' href='http://www.php001.net'></a>");
...
</script></span></td></tr></\></\></td></tr></table></div>